...
class CalculatorComponentSubDataTable extends DataTable
{
    /**
            ...
            ->addColumn(
                ...
                function ($object) {
                    return view('layouts.action_table', [
                        'viewAction'  => route('admin.calculator.component.sub.show', [$object->parent_id, $object->id]),
                        'editAction'  => route('admin.calculator.component.sub.edit', [$object->parent_id, $object->id]),
                        'deleteAction'  => route('admin.calculator.component.sub.destroy', [$object->parent_id, $object->id]),
                    ])->render();
    ...
    {
        $query = $model::select(['calculator_components.*'])->where('parent_id', $this->component_id);
