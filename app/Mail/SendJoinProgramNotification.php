...
class SendJoinProgramNotification extends Mailable {
    ...
    public function build() {
		...
		$this->__data['body'] = explode('[user-data]', $this->__data['body']);
		
		return $this->view('emails.send-join-program', [ 'data' => $this->__data ]);
    }
}