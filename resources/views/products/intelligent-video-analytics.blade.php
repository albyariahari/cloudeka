...
@section('content')
    ...
    <div class="container-fluid banner">
        <div class="banner-title">
            <img src="/imgs/products/banners/intelligent-video-analytics.png" alt="Intelligent Video Analytics" class="w-100">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    <div class="d-flex w-100 justify-content-center justify-content-lg-start">
                        <img src="/imgs/products/kazee.png" width="300">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="owl-carousel owl-slide owl-carousel-1 owl-theme">
                            ...
                            <div class="slide-logo-light slide-logo-light--use-cases">
                                <div class="img-wrapper mb-4 mt-0">
                                    <img src="/imgs/solutions/JSC.png" class="w-auto m-auto">
                                </div>
                                <p>“something exciting is coming to town”</p>
                            </div>
                            <div class="slide-logo-light slide-logo-light--use-cases">
                                <div class="img-wrapper mb-4 mt-0">
                                    <img src="/imgs/solutions/mimika.png" class="w-auto m-auto">
                                </div>
                                <p>“something exciting is coming to town”</p>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-2 offset-lg-1 pb-4">
                    <h2 class="subtitle dark-color mb-5">Intelligent Video Analytics <br>Features and Benefit</h2>
                </div>
                <div class="col-lg-8 dark-color pt-2">
                    <div class="row product-lists owl-carousel owl-theme">
                        <div class="col-12 col-lg-6 col-xl-4 px-xl-4 pb-0 pb-lg-5">
                            <img src="/imgs/products/feature-products/meticulous-monitoring.svg" class="img-fluid" style="max-width: 100px; height:100px;">
                            <h4 class="mt-4 mb-3">Meticulous Monitoring</h4>
                        ...
                        <div class="col-12 col-lg-6 col-xl-4 px-xl-4 pb-0 pb-lg-5">
                            <img src="/imgs/products/feature-products/capture-all-moment.svg" class="img-fluid" style="max-width: 100px; height:100px;">
                            <h4 class="mt-4 mb-3">Capture All Moments</h4>
                        ...
                        <div class="col-12 col-lg-6 col-xl-4 px-xl-4 pb-0 pb-lg-5">
                            <img src="/imgs/products/feature-products/flexible.svg" class="img-fluid" style="max-width: 100px; height:100px;">
                            <h4 class="mt-4 mb-3">Flexible</h4>
                            <p>Lintasarta IVA can be hosted on-premises or in the Cloud, and its compact size makes it the best solution for embedded or edge deployments. Half-in cloud type allows detection to be handled near  the camera location.</p>
                        </div>
                        <div class="col-12 col-lg-6 col-xl-4 px-xl-4 pb-0 pb-lg-5">
                            <img src="/imgs/products/feature-products/security-and-compilance-2.svg" class="img-fluid" style="max-width: 100px; height:100px;">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="offset-1 col-10 text-center">
                    <h3 class="light-color mb-5">See Our Solutions Industry Covered by <strong>Intelligent Video Analytics</strong> Product</h3>
