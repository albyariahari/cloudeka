...
@if (count($productTranslate->Product->UseCases()->where('status', 1)->get()) > 0)
                    ...
                    <div class="owl-carousel owl-slide owl-carousel-1 owl-theme">
                        ...
                        <div class="slide-logo-light slide-logo-light--use-cases" data-aos="fade-up" data-aos-duration="500" data-aos-delay="{{ $key + 1 }}00">
                            <div class="img-wrapper mb-4 mt-0">
                                <img src="{{ cloudekaBucketLocalUrl($UseCase->Client->logo) }}" class="w-auto m-auto" alt="Icon" loading="lazy">
                            </div>
                ...
                @foreach ($packages as $key => $item)
                    <div class="cards__package">
                        ...
                        <div class="cards__package--detail">
                            ...
                            <a href="{{route('calculator', ['calculator' => $productTranslate->slug, 'package' => $item->name ])}}" class="btn btn-block btn-secondary btn-rounded btn-gradient description">
...
<section class="sections">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-2 offset-lg-1 pb-4" data-aos="fade-up" data-aos-duration="500">
                <h2 class="subtitle dark-color mb-5">{{ __('title.features_and_benefit', ['product' => $productTranslate->title]) }}</h2>
            </div>
            <div class="col-lg-8 dark-color pt-2">
                <div class="row product-lists owl-carousel owl-theme">
                    ...
                    <div class="col-12 col-lg-6 col-xl-4 px-xl-4 pb-0 pb-lg-5" data-aos="fade-up" data-aos-duration="500" data-aos-delay="{{ $key + 2 }}00">
                        <img src="{{ cloudekaBucketLocalUrl($benefit->translate($lang)->icon) }}" class="img-fluid" style="max-width: 100px; height:100px;" alt="Icon" loading="lazy">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center mt-3">
            <a href="{{route('calculator', ['calculator' => $productTranslateEN->slug ])}}" class="btn btn-secondary btn-rounded mx-2 px-4 btn-gradient min-width mt-2 description">{{ __('title.see_pricing') }}</a>
            <a href="{{route('product.index')}}" class="btn btn-secondary btn-rounded mx-2 px-4 btn-gradient min-width mt-2 description">{{ __('title.see_all_products') }}</a>
            <a href="https://cmd.cloudeka.id/" class="btn btn-secondary btn-rounded mx-2 px-4 btn-gradient min-width mt-2 description">Portal</a>
            <a href="{{route('contact-us')}}" class="btn btn-secondary btn-rounded mx-2 px-4 btn-gradient min-width mt-2 description">{{ __('title.contact_us') }}</a>
        </div>
    </div>
</section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="offset-lg-1 col-lg-10 text-center">
                    <h3 class="light-color font-25 mb-5" data-aos="fade-up" data-aos-duration="500" data-aos-delay="{{ $key + 1 }}00">{{ __('title.see_our_solutions', ['product' => $productTranslate->title]) }}</h3>
                    <div class="owl-carousel owl-slide owl-carousel-2 owl-theme">
                        ...
                        <div class="slide-logo-light" data-aos="fade-up" data-aos-duration="500" data-aos-delay="{{ $key + 2 }}00">
                            ...
                            <p class="text-center mt-1 description">
                                ...
                                <a href="{{ route('solution.show',$solution->translate($lang)->slug) }}">Read More</a>
                            </p>
                        </div>
                        @endforeach
                    </div>
