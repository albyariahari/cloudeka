...
@section('content')
    ...
    <div class="container-fluid banner">
        <div class="banner-title">
            <img src="/imgs/solutions/solution-detail.jpg" alt="Government Solution" class="w-100">
            <h1>Government<br>Solution</h1>
            <div class="icon-product"><i class="icon-goverment my-auto"></i></div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-xl-3 offset-xl-1 pr-5">
                    <h2 class="subtitle dark-color">Why Choose Us For Government Solutions?</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 dark-color pt-2">
                    <div class="row mb-3 product-solutions owl-carousel owl-theme">
                        ...
                        <div class="col-md-6 col-lg-4 mb-5 px-md-3 px-xl-4">
                            <div class="d-flex align-items-center mb-4">
                                <i class="icon-cloud-bucket rounded-icon mr-3 filled"></i>
                                <h4>Cloud<br>Bucket</h4>
                            </div>
                            <p>Object Storage service for managing corporate applications and data.</p>
                            <a href="#" class="read-more">Read more <i class="icon-arrow-right  font-20"></i></a>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-5 px-md-3 px-xl-4">
                            <div class="d-flex align-items-center mb-4">
