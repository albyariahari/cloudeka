...
@section('content')
    ...
    <div class="container-fluid banner">
        <div class="banner-title">
            <img src="/imgs/solutions/solution-detail.jpg" alt="Finance Non-Bank" class="w-100">
            <h1>Finance Non-Bank</h1>
            <div class="icon-product"><i class="icon-non-banking my-auto"></i></div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-xl-3 offset-xl-1 pr-5">
                    <h2 class="subtitle dark-color">Why Choose Us For Finance Non-Bank Solutions?</h2>
                </div>
