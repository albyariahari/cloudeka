...
@section('content')
    ...
    <div class="container-fluid banner">
        <div class="banner-title">
            <img src="/imgs/solutions/solution-detail.jpg" alt="Telco" class="w-100">
            <h1>Telco</h1>
            <div class="icon-product"><i class="icon-telco my-auto"></i></div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-xl-3 offset-xl-1 pr-5">
                    <h2 class="subtitle dark-color">Why choose us for<br>Telco Solutions?</h2>
                </div>
