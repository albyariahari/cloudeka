...
@section('content')
	...
	<div class="card">
		<div class="card-header with-border">
			<a href="{{ route('admin.promotion.create') }}" class="btn btn-sm btn-success pull-right">Create Content</a>
		</div>
		<div class="card-body">
			{!! $dataTable->table() !!}
		</div>
...
<script>
	...
	$(document).ready(function () {
		...
		__doc.on('click', '.status-button', function () {
			ShowWarning("Selecting this as popup will set all other promotions as 'No'!", $(this), 'PUT');
		});
	});
</script>
@endpush