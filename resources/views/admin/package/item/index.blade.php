...
<div class="card">
    <div class="card-header with-border">
        <a href="{{route('admin.package.item.create',$package_id)}}" class="btn btn-sm btn-success pull-right">Create Content</a>
    </div>
    <div class="card-body">
            {!! $dataTable->table() !!}
		</div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.remove-featured-action', function() {
        url = $(this).data('url');
        selectorDeleted = $(this);
