      	...
      	<div class="card card-default">
      		...
      		<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="package_type_id"  class="form-control" style="width: 100%;" placeholder="Select Package Type">
                            <option selected disabled value="">Select Package Type</option>
                            @foreach ($packageType as $item)
                            <option value="{{$item->id}}" {{(int)old('package_type_id')===$item->id ? 'selected':''}}>{{$item->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea id="editor-short-desc-id" name="excerpt_id" rows="10" cols="80">{{ old('excerpt_id')}}</textarea>                        
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea id="editor-short-desc-en" name="excerpt_en" rows="10" cols="80">{{ old('excerpt_en')}}</textarea>
