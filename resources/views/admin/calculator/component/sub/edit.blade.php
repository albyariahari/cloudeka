...
<!-- Default box -->
	<!-- form start -->
	<form action="{{route('admin.calculator.component.sub.update',[$parent_component->id,$component->id])}}" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form">
		@csrf
        @method('PUT')
      	...
      	<div class="card card-default">
      		...
      		<div class="card-body">
        		...
        		<div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Title" value="{{ old('title',$component->title)}}" name="title">
        		...
        		<div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Unit" value="{{ old('unit',$component->unit)}}" name="unit">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Hint" value="{{ old('hint',$component->hint)}}" name="hint">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="data_type" class="form-control" style="width: 100%;">
                            ...
                            <option value="{{$item}}" {{$item === old('data_type',$component->data_type)?'selected':''}}>{{ucfirst(str_replace('-',' ',$item))}}</option>
                            @endforeach
                        </select>
        		...
        		<div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Data Group" value="{{ old('data_group',$component->data_group)}}" name="data_group">
                    ...
                    <div class="col-sm-10">
                        <div class="card card-default">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" value="{{ old('price.pay-as-you-use',$component->price['pay-as-you-use'] ?? 0)}}" name="price[pay-as-you-use]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" value="{{ old('price.monthly',$component->price['monthly'] ?? 0)}}" name="price[monthly]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" value="{{ old('price.1-year',$component->price['1-year'] ?? 0)}}" name="price[1-year]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" value="{{ old('price.3-year',$component->price['3-year'] ?? 0)}}" name="price[3-year]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" placeholder="0" value="{{ old('price.5-year',$component->price['5-year'] ?? 0)}}" name="price[5-year]">
