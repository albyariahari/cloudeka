...
<!-- Default box -->
	<!-- form start -->
	<form action="{{route('admin.calculator.update',$calculator->id)}}" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form">
		@csrf
        @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="product_id"  class="form-control" style="width: 100%;" id="product">
                            ...
                            <option value="{{$item->id}}" {{(int)old('product_id',$calculator->product_id) === $item->id ? 'selected':''}}>{{$item->title}}</option>
                            @endforeach
                        </select>
              ...
              <div class="card-header with-border">
                ...
                <div class="card-body" id="component-wrapper">
                    @if (old('component'))
                                                                        ...
                                                                        <div class="card card-default pricing-impact-rules-action">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <select name="component[{{$keyComponent}}][pricing_impact_rules][{{$keyPricingImpactRule}}][action][{{$keyAction}}][]"  class="form-control pricing-impact-rules-action-operation" style="width: 100%;">
                        ...
                        @endforeach
                    @else
                        @foreach ($calculator->CalculatorComponents as $keyComponent => $calComponent)
                        <div class="card card-default border border-dark component">
                            <div class="card-header border-0 p-0 m-0">
                                <button type="button" class="delete-component btn btn-danger float-right" data-index="0">X</button>
                                <button type="button" class="move-component btn btn-info float-right mr-2" data-index="down"><i class="fa fa-arrow-down"></i></button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <option selected value="0">Select Component</option>
                                            @foreach ($components as $item)
                                            <option value="{{$item->id}}" {{$calComponent->id === $item->id ? 'selected':''}}>{{$item->title}} {{$item->unit ? '('.$item->unit.')': ''}} {{$item->parentComponent ? '('.$item->parentComponent->title.')' : ''}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="card card-default">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">Pay as You Use</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control pay-as-you-use" placeholder="0" value="{{$price['pay-as-you-use'] ?? 0}}" name="component[{{$keyComponent}}][price][pay-as-you-use]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">Monthly</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control monthly" placeholder="0" value="{{$price['monthly'] ?? 0}}" name="component[{{$keyComponent}}][price][monthly]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">1-year</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control 1-year" placeholder="0" value="{{$price['1-year'] ?? 0}}" name="component[{{$keyComponent}}][price][1-year]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">3-year</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control 3-year" placeholder="0" value="{{$price['3-year'] ?? 0}}" name="component[{{$keyComponent}}][price][3-year]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">5-year</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control 5-year" placeholder="0" value="{{$price['5-year'] ?? 0}}" name="component[{{$keyComponent}}][price][5-year]">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-default">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">Min</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control rule_min_value" placeholder="0" value="{{$calComponent->pivot->rule_min_value}}" name="component[{{$keyComponent}}][rule_min_value]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 control-label">Max</label>
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control rule_max_value" placeholder="0" value="{{$calComponent->pivot->rule_max_value}}" name="component[{{$keyComponent}}][rule_max_value]">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="component[{{$keyComponent}}][rule_must_be_even]" class="form-control rule_must_be_even" style="width: 100%;">
                                                            <option selected value="0">Select Must be even</option>
                                                            <option value="1" {{$calComponent->pivot->rule_must_be_even === 1 ? 'selected' : ''}}>True</option>
                                                            <option value="0" {{$calComponent->pivot->rule_must_be_even === 0 ? 'selected' : ''}}>False</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="component[{{$keyComponent}}][rule_editable]" class="form-control rule_editable" style="width: 100%;">
                                                            <option selected value="0">Select Editable</option>
                                                            <option value="1"{{$calComponent->pivot->rule_editable === 1 ?'selected':''}}>True</option>
                                                            <option value="0"{{$calComponent->pivot->rule_editable === 0 ?'selected':''}}>False</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="component[{{$keyComponent}}][display_mode]" class="form-control display_mode" style="width: 100%;">
                                                            <option selected value="">Select Display mode</option>
                                                            <option value="50%"{{$calComponent->pivot->display_mode === '50%' ?'selected':''}}>50%</option>
                                                            <option value="100%"{{$calComponent->pivot->display_mode === '100%' ?'selected':''}}>100%</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="component[{{$keyComponent}}][visible]" class="form-control rule_visible" style="width: 100%;">
                                                            <option selected value="0">Select Visible</option>
                                                            <option value="1"{{$calComponent->pivot->visible === 1 ?'selected':''}}>True</option>
                                                            <option value="0"{{$calComponent->pivot->visible === 0 ?'selected':''}}>False</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                @php
                                    $other_rules = json_decode($calComponent->pivot->other_rules,true);
                                @endphp
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Other Rules</label>
                                    <div class="col-sm-10">
                                        <div class="card card-default">
                                            <div class="card-body other-rules-wrapper" id="other-rules-wrapper-{{$keyComponent}}">
                                                @if ($other_rules)
                                                    @foreach ($other_rules as $keyOtherRules => $other_rule)
                                                    <div class="card card-default other-rules">
                                                        <div class="card-header border-0 p-0 m-0">
                                                            <button type="button" class="delete-other-rules btn btn-danger float-right" data-index="0">X</button>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-2 control-label">Component</label>
                                                                <div class="col-sm-10">
                                                                    <select name="component[{{$keyComponent}}][other_rules][{{$keyOtherRules}}][slug]"  class="form-control other_rules_slug" style="width: 100%;">
                                                                    <option selected value="0">Select Component</option>
                                                                        @foreach ($components as $item)
                                                                        <option value="{{$item->slug}}" {{($other_rule['slug'] ?? null) === $item->slug ? 'selected' : ''}}>{{$item->title}} {{$item->unit ? '('.$item->unit.')': ''}} {{$item->parentComponent ? '('.$item->parentComponent->title.')' : ''}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="inputEmail3" class="col-sm-2 control-label">Value</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control other_rules_value" placeholder="Value" value="{{$other_rule['value'] ?? null}}" name="component[{{$keyComponent}}][other_rules][{{$keyOtherRules}}][value]">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                @php
                                    $pricing_impact_rules = json_decode($calComponent->pivot->pricing_impact_rules,true);
                                @endphp
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Pricing Impact Rules</label>
                                    <div class="col-sm-10">
                                        <div class="card card-default">
                                            <div class="card-body pricing-impact-rules-wrapper" id="pricing-impact-rules-wrapper-{{$keyComponent}}">
                                                @if ($pricing_impact_rules)
                                                    @foreach ($pricing_impact_rules as $keyPricingImpactRule => $pricing_impact_rule)
                                                    <div class="card card-default pricing-impact-rules">
                                                        <div class="card-header border-0 p-0 m-0">
                                                            <button type="button" class="delete-pricing-impact-rules btn btn-danger float-right" data-index="0">X</button>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <option selected value="0">Select Component</option>
                                                                        @foreach ($components as $item)
                                                                        <option value="{{$item->slug}}" {{($pricing_impact_rule['slug'] ?? null) === $item->slug ? 'selected' : ''}}>{{$item->title}} {{$item->unit ? '('.$item->unit.')': ''}} {{$item->parentComponent ? '('.$item->parentComponent->title.')' : ''}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var product_id = {!! old('product_id',$calculator->product_id) !!}
            var package_id = {!! old('package_id',($calculator->package_id ?? 0)) !!}
            if (product_id) {
