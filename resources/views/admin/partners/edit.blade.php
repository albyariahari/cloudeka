...
<!-- Default box -->
	<!-- form start -->
	<form action="{{ route('admin.partners.update', $content->id) }}" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form">
		@csrf
        @method('PUT')
        <span class="form-button">
			<a href="{{ route('admin.partners.index') }}" class="btn btn-secondary pull-right">Back</a>
      	...
      	<div class="card card-default">
      		...
      		<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<img src="{{ asset("/storage/{$content->logo}") }}" class="img-responsive">
					</div>
				</div>
      		</div>
      		<!-- /.card-body -->
