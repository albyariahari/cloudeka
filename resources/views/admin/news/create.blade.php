...
<!-- Default box -->
	<!-- form start -->
	<form action="{{route('admin.news.store')}}" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form">
		@csrf
        <span class="form-button"><a href="{{route('admin.news.index')}}" class="btn btn-secondary pull-right">Back</a><button type="submit" class="btn btn-success pull-right create">Create</button></span>
        @include('layouts.session')
      	<!-- Default box -->
        <input type="hidden" value="{{ app('request')->get('type','news')}}" name='type'>
      	<div class="card card-default">
      		...
      		<div class="card-body">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" name="news_category_id">
                            ...
                            @foreach($categories as $category)
                                <option value="{{$category->id}}" {{ old('news_category_id') === $category->id ? 'selected="selected"' : ''}}>{{$category->translate()->title}}</option>
                            @endforeach
                        </select>
                ...
                @if (app('request')->get('type','news') === 'event')

                    <x-inputs name="start_date" type="date" placeholder="dd/mm/yyyy" note="Required, If type event" />
                    <x-inputs name="end_date" type="date" placeholder="dd/mm/yyyy" note="Required, If type event, After Start Date" />
                ...
                <div class="form-group d-none row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="short_description" rows="3" cols="80" class="form-control">{{old('short_description')}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="summary" rows="3" cols="80" class="form-control">{!! old('summary') !!}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Tags" value="{{ old('tags')}}" name="tags">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="meta_keyword" placeholder="Keyword" rows="3">{{ old('meta_keyword') }}</textarea>
