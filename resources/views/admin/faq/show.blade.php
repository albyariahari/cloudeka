                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        @if ($product->translate($lang)->logo_1 != '' || !is_null($product->translate($lang)->logo_1))
                            <img src="{{env('APP_URL').'/storage/'.$product->translate($lang)->logo_1}}" class="img-responsive"  style="width: 350px !important">
                        @endif
                    </div>
                </div>
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        @if ($product->translate($lang)->logo_2 != '' || !is_null($product->translate($lang)->logo_2))
                            <img src="{{env('APP_URL').'/storage/'.$product->translate($lang)->logo_2}}" class="img-responsive"  style="width: 350px !important">
                        @endif
                    </div>
                </div>
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        @if ($product->translate($lang)->images != '' || !is_null($product->translate($lang)->images))
                            <img src="{{env('APP_URL').'/storage/'.$product->translate($lang)->images}}" class="img-responsive"  style="width: 650px">
                        @endif
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                @if ($item->translate($lang)->icon != '' || !is_null($item->translate($lang)->icon))
                                    <img src="{{env('APP_URL').'/storage/'.$item->translate($lang)->icon}}" class="img-responsive"  style="width: 630px">
                                @endif
                            </div>
                        </div>
