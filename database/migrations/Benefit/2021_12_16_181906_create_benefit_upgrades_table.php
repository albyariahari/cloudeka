...
class CreateBenefitUpgradesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('benefit_upgrades', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('category_id')->references('id')->on('benefit_categories')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('benefit_upgrades');
    }
}
